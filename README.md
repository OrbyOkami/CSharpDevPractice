...
|------------------|--------------------------------|
| Test             | Типы данных: задание 1         |
| Task2            | Типы данных: задание 2         |
| Task3            | ООП/Задание                    |
| CollectionTask   | Коллекции/Задание              |
| DbTaskRequests   | Базы данных/Задание            |
| AppWorkWithDb    | Работа с БД из кода/Задание    |
| HttpTask         | HTTP/Задание                   |
| TimeCRM          | Финальное задание: Backend     |
| TimeCRMWebApp    | Финальное задание: Frontend    |

# Финальное задание: Приложение учёта рабочего времени (TimeCRM)
